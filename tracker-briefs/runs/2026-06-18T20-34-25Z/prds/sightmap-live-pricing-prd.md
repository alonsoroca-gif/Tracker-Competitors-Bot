...
- **Evidence:** `tracker-drops/2026-06-18T20-34-25Z/signals.json` — Jonah Digital add-ons row; signals-table id 9
...
- **Existing Entrata implementation:**
  ...
  - Parity verdict: **Partial** (L1: Partial 29 score / 8 files; L2: embed foundation confirmed, no live per-unit rent pin overlay + tour handoff found)
