...
- **Run id:** `2026-08-24T12-08-23Z`
- **Created (UTC):** 2026-08-24T12:08:23.994Z
- **New signals added this collect:** 495
- **Retention window (days):** 7
- **Signals kept after prune:** 495 (removed as too old: 0)
...
- `jonah-digital`: 44 → 0 rows

Configured scrape lanes **failed** (not silent empty — fix these):

- `jonah-digital` / `features_url`: fetch failed — https://jonahdigital.com/add-ons/
